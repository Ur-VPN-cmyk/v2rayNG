...
object SettingsManager {
    ...
    private fun initRoutingRulesets(context: Context) {
        com.v2ray.ang.util.AppPresetConfig.ensureGlobalRoutingDefaults(context)
    }
     ...
     */
    fun getPresetRoutingRulesets(context: Context, type: RoutingType = RoutingType.GLOBAL): MutableList<RulesetItem>? {
    ...
    private fun ensureDefaultSettings() {
        ...
        ensureDefaultValue(AppConfig.PREF_ROUTING_DOMAIN_STRATEGY, "AsIs")
